...
func ContextCreateSuccess() *service_mock.CreateGroupServiceMock {
	groupServiceMock := new(service_mock.CreateGroupServiceMock)
	...
	groupServiceMock.On(service_mock.CreateGroup, *group).Return(groupOutputDTO, (*util.ValidationError)(nil))
	return groupServiceMock
}

func ContextCreateReturnErrorGroupServiceCreateGroup() *service_mock.CreateGroupServiceMock {
	...
	groupServiceMock.On(service_mock.CreateGroup, *gourp).Return(groupOutputDTO, err)
	return groupServiceMock
}
